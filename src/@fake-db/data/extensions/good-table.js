...
mock.onGet('/good-table/safetyAlerts').reply(() => [200, data.safetyAlerts])
mock.onGet('/good-table/actions').reply(() => [200, data.actions])
mock.onGet('/good-table/incidents').reply(() => [200, data.incidents])
...
mock.onPost('/good-table/incidents').reply(()=>{
    return new Promise(function(resolve) {
     setTimeout(function() {
      // const data = JSON.parse(config.data);
      incidents.push({ id: users.length + 1,    title: "Boiling water",
      date: "2021/09/08 - 10:30 PM",
      category: "Workplace incident",
      employee: 'John doe',
      location: 'kitchen',
