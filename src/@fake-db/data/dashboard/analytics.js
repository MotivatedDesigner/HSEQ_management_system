...
const data = {
  ...
  timeline: {
    ...
    step3: {
      ...
      duration: '2 day ago',
      avatars: [
        // { user// img:  require('@/assets/images/portrait/small/avatar-s-9.jpg'), name: 'Billy Hopkins' },
        // { user// img:  require('@/assets/images/portrait/small/avatar-s-6.jpg'), name: 'Amy Carson' },
        // { user// img:  require('@/assets/images/portrait/small/avatar-s-8.jpg'), name: 'Brandon Miles' },
        // { user// img:  require('@/assets/images/portrait/small/avatar-s-7.jpg'), name: 'Daisy Weber' },
        // { user// img:  require('@/assets/images/portrait/small/avatar-s-20.jpg'), name: 'Jenny Looper' },
      ],
    },
    step4: {
      title: 'Create a new project for client',
