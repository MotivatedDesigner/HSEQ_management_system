<template>
  ...
  >
    ...
    >
      ...
      >
        <app-navbar-worker-layout :toggle-vertical-menu-active="toggleVerticalMenuActive" />
      </slot>
    </b-navbar>
    <!--/ Navbar -->

    <!-- Vertical Nav Menu -->
    <vertical-nav-menu-worker
...
import AppNavbarWorkerLayout from '@core/layouts/components/app-navbar/AppNavbarWorkerLayout.vue'
import useAppConfig from '@core/app-config/useAppConfig'
import { BNavbar } from 'bootstrap-vue'
import LayoutContentRendererDefault from '@core/layouts/components/layout-content-renderer/LayoutContentRendererDefault.vue'
import LayoutContentRendererLeft from '@core/layouts/components/layout-content-renderer/LayoutContentRendererLeft.vue'
import LayoutContentRendererLeftDetached from '@core/layouts/components/layout-content-renderer/LayoutContentRendererLeftDetached.vue'
import VerticalNavMenuWorker from './components/vertical-nav-menu/VerticalNavMenuWorker.vue'
...
export default {
  components: {
    // AppBreadcrumb,
    AppNavbarWorkerLayout,
    VerticalNavMenuWorker,
    BNavbar,
