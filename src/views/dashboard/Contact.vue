...
<div class="nano-content">
  ...
  <div class="text-center">
      <a href="#custom-modal" class="btn btn-primary btn-rounded width-lg waves-effect waves-light mb-2 mt-3" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#36404a">Compose</a>
  </div>
...
<header class="header">
  ...
  <div class="action-bar float-left">
